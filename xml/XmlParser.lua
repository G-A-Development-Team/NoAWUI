...
function decimalToHtmlChar(code)
...
function hexadecimalToHtmlChar(code)
...
function fexists(table, elementName)
    if table == nil then
        return false
    end
...
function parseXmlDeclaration(self, xml, f)
    -- XML Declaration
...
function parseXmlProcessingInstruction(self, xml, f)
    local tag = {}
...
function parseComment(self, xml, f)
...
function parseCdata(self, xml, f)
...
function parseNormalTag(self, xml, f)
    --Check for errors
    while 1 do
...
function parseTagType(self, xml, f)
    -- Test for tag type
...
function getNextTag(self, xml, f)
